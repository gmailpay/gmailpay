...
export default function AppLayout() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      {!isInApp && <div className="mx-4 mt-2 max-w-6xl lg:mx-auto w-auto">
        <a href="https://github.com/gmailpay/gmailpay/releases/download/v1.0.0/app-release.apk" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 bg-primary/10 border border-primary/30 rounded-xl px-4 py-3 hover:bg-primary/20 transition-colors">
          <div className="w-10 h-10 rounded-xl bg-primary/20 flex items-center justify-center shrink-0">
            <svg className="w-5 h-5 text-primary" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
          </div>
          <div className="flex-1 min-w-0">
            <p className="text-sm font-semibold text-foreground">Download GmailPay App</p>
            <p className="text-xs text-muted-foreground">Get the full Android app experience</p>
          </div>
          <span className="px-3 py-1.5 bg-primary text-primary-foreground rounded-lg text-xs font-bold shrink-0">Download</span>
        </a>
      </div>}
