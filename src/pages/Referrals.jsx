...
export default function Referrals() {
  ...
  const link = user ? `${window.location.origin}/Dashboard?ref=${encodeURIComponent(user.email)}` : "";
  const cp = () => { navigator.clipboard.writeText(link); toast.success("Copied!"); };
